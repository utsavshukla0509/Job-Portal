      ...
      <header >
        ...
        <div className="sidebar-fixed position-fixed">
          ...
          <div className="list-group list-group-flush">
            <a href="#" onClick = {()=>{onOption("addjob")}} 
              className = {"list-group-item waves-effect" + this.checkClass("addjob",active)}>
              <i className="far fa-images mr-3"></i>Add Job</a>
            <a href="#" 
              onClick = {()=>{onOption("showjob")}} 
              className = {"list-group-item waves-effect" + this.checkClass("showjob",active)}>
              <i className="fas fa-clock mr-3"></i>All Jobs</a>
          </div>
        </div>
      </header>
    );
